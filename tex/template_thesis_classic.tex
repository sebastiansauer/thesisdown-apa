...
\newcommand{\myProf}{$referee1$\xspace}
\newcommand{\myOtherProf}{$referee2$\xspace}
\newcommand{\mySupervisor}{Put name here\xspace}
\newcommand{\myMatrikel}{$id$\xspace}
\newcommand{\myDepartment}{Put data here\xspace}
\newcommand{\myUni}{FOM Hochschule f\"ur Oekonomie und Management\xspace}
\newcommand{\myLocation}{$location$\xspace}
\newcommand{\myTime}{$mytime$\xspace}
\newcommand{\myVersion}{$myversion$\xspace}
...
$if(subtitle)$
\huge
\color{Maroon}\textsc{$title$} \LARGE \\$subtitle$\\ \bigskip % Thesis title
$else$
\LARGE
