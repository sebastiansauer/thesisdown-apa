...
\PassOptionsToPackage{eulerchapternumbers, listings, pdfspacing, subfig, beramono, eulermath, parts, dottedtoc}{style/classicthesis}
...
\includegraphics[width=3cm]{images/bookdownplus-logo.pdf} \\ \medskip % Picture
\myUni \\ \bigskip
...
\StringTok{  }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{factor}\NormalTok{(cyl), }\DataTypeTok{y =}\NormalTok{ hp) }\OperatorTok{+}
...
{\centering \includegraphics[width=0.9\linewidth]{classic_files/figure-latex/apa1-1} 
...
\StringTok{  }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{booktabs =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{caption =} \StringTok{"APA-konforme Tabelle"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{table}[t]

\caption{\label{tab:unnamed-chunk-3}APA-konforme Tabelle}
\centering
\begin{tabular}{lrrrr}
\toprule
  & mpg & cyl & disp & hp\\
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_table <-}\StringTok{ }\KeywordTok{t}\NormalTok{(}\KeywordTok{apply}\NormalTok{(cars, }\DecValTok{2}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(x) }\CommentTok{# Create data}
...
\NormalTok{  my_table}
\NormalTok{  , }\DataTypeTok{align =} \KeywordTok{c}\NormalTok{(}\StringTok{"l"}\NormalTok{, }\KeywordTok{rep}\NormalTok{(}\StringTok{"r"}\NormalTok{, }\DecValTok{3}\NormalTok{))}
\NormalTok{  , }\DataTypeTok{caption =} \StringTok{"A summary table of the cars dataset."}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{tab:mtcars}A summary table of the cars dataset.}
\begin{tabular}{lrrrl}
\toprule
